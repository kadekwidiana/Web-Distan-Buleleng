...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <>
            <Head title="Login" />
            <div className="px-6 pt-8 lg:px-72 lg:pt-14">
                <div className="rounded-md border border-stroke bg-white shadow-xl">
                                ...
                                <form onSubmit={submit}>
                                    <div className="mb-4">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full rounded-md bg-white border border-gray-400 py-4 px-5 text-black transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter focus:outline-none focus-visible:outline-none focus:ring-blue-500 focus:border-blue-500"
                                            />

                                            <span className="absolute right-4 top-4 text-gray-500 text-xl">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="relative">
                                            ...
                                            <span onClick={handleShowPassword} className="absolute right-4 top-4 text-gray-500 text-xl">
                                                {showPassword ?
                                    ...
                                    <div className="block my-4">
                                        <label className="flex items-center">
                                            ...
                                            />
                                            <span className="ms-2 text-base text-gray-800">Ingat Saya</span>
                                        </label>
                                    </div>

                                    <div className="mb-5">
                                        <button type='submit' className={`${processing ? 'p-3.5 cursor-not-allowed' : 'p-4'} w-full cursor-pointer rounded-lg border border-primary bg-blue-500 text-white transition hover:bg-blue-600`}>
                                            {processing ?
                                                <>
                                                    <svg aria-hidden="true" role="status" className="inline w-7 me-1 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        {/* <input
                                            ...
                                            type="submit"
                                            value="Login"
                                            className="w-full cursor-pointer rounded-lg border border-primary bg-blue-500 p-4 text-white transition hover:bg-blue-600"
                                        /> */}
                                    </div>
