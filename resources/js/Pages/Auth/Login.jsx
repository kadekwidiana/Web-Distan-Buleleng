                        ...
                        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                ...
                                <form onSubmit={submit}>
                                    ...
                                    <div className="mb-5">
                                        <button type='submit' disabled={processing} className={`${processing ? 'cursor-wait' : ''} p-4 w-full cursor-pointer rounded-lg border border-primary bg-blue-500 text-white transition hover:bg-blue-600`}>
                                            {processing ?
                                                'Login...'
                                                :
                                                'Login'
