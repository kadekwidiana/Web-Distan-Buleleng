            ...
            <FrontpageLayout>
                <section className="mt-16 lg:mt-20">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-12">
                        <h1 className="mb-4 text-4xl font-bold leading-none text-gray-800 md:text-4xl lg:text-5xl">Selamat Datang Di Sistem Informasi Produk Pertanian Dinas Pertanian Kabupaten Buleleng</h1>
                        <p className="mb-8 text-lg font-normal text-gray-600 lg:text-xl sm:px-16 lg:px-36">
                            Sistem Informasi Produk Pertanian Dinas Pertanian Kabupaten Buleleng adalah platform yang menyediakan data geografis lengkap dan akurat untuk mendukung pengelolaan serta pengembangan sektor pertanian. Sistem ini memudahkan pengguna mengakses peta interaktif, informasi lahan, batas wilayah, dan data penting lainnya yang relevan dengan pertanian di Kabupaten Buleleng. Sistem ini merupakan pengembangan dari aplikasi mobile SIPROTANI, platform ini menawarkan fitur yang lebih lengkap dan mudah diakses.
                        </p>
