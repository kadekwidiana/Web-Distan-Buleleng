...
export default function DetailVillagePage() {
    const { villageById } = usePage().props;

    return (
        <BackpageLayout>
            <Head title="Detail Desa" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-3">
                        <div className="relative overflow-x-auto">
                            <ButtonBack url={`/master-data/desa`} />
                            <table className="w-full text-sm text-left rtl:text-right text-gray-700">
                                <tbody>
                                    <tr className="bg-white">
                                        <td className="pr-2 py-2 w-1/5">Nama</td>
                                        <td className="px-2 py-2 w-3">:</td>
                                        <td className="px-2 py-2 w-full">{villageById.name}</td>
                                    </tr>
                                    <tr className="bg-white">
                                        <td className="pr-2 py-2 w-1/5">Kecamatan</td>
                                        <td className="px-2 py-2 w-3">:</td>
                                        <td className="px-2 py-2 w-full">{villageById.district.name}</td>
                                    </tr>
                                    <tr className="bg-white">
                                        <td className="pr-2 py-2 w-1/5">Luas</td>
                                        <td className="px-2 py-2 w-3">:</td>
                                        <td className="px-2 py-2 w-full">{villageById.wide}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div className="flex flex-col gap-3">
                        <MapsDetailData data={villageById} isRegion />
                    </div>
                </div>
            </div>
        </BackpageLayout>
