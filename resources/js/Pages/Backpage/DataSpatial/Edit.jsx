...
export default function EditDataSpatialPage() {
    const { dataSpatialById, layerGroup, errors } = usePage().props;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="">
                                ...
                                >
                                    <option value="">-- Pilih tipe spasial --</option>
                            ...
                            <div className="w-full">
                                ...
                                {dataSpatialById.file &&
                                    <a href={`/storage/${dataSpatialById.file}`} target='_blank' className="w-28 p-1 border rounded-md text-white bg-cyan-800">Cek File</a>
                                }
                                <input
                                    type="file"
                                    name="file"
