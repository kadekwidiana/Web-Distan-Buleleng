...
export default function EditOutreachActivityPage() {
    ...
    const [selectedValuesPoktan, setSelectedValuesPoktan] = useState(poktanOutreachActivityIds ?? []); //value options yang di pilih
    ...
    const handleSubmit = (e) => {
        ...
        post(route('outreachActivities.update', { districtId: district.id, id: outreachActivityById.id }), {
            data: formData,
            onSuccess: () => {
                Toast.fire({
                    icon: "success",
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="">
                                <MapsInputData isEdit={true} data={outreachActivityById} />
                            </div>
                        </div>
                    </div>
